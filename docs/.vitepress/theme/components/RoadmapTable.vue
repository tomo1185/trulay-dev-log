...
const tasks = [
  ...
  ["TRULAY-7", "フェーズ1", "基本設計", "認証機能の基本設計", "完了", "5h", "5/25", "5/29"],
  ["TRULAY-8", "フェーズ1", "基本設計", "プロフィール機能の基本設計", "完了", "4h", "5/28", "5/31"],
  ["TRULAY-9", "フェーズ1", "基本設計", "企業情報管理機能の基本設計", "完了", "5h", "5/30", "6/3"],
  ...
  ["TRULAY-30", "共通", "開発", "公開ページ実装", "未着手", "8h", "未定", "未定"],
